...
public class QuestionEditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mQuestionId == -1) {
            ...
            String defaultQuestion = sharedPrefs.getString(SettingsFragment.PREFERENCE_DEFAULT_QUESTION, "");
            mQuestion.setText(defaultQuestion);
            mQuestionText.setText(defaultQuestion);
